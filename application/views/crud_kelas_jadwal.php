...
<head>
    ...
    <title>Kelola Kelas dan Jadwal</title>
    <!-- Bootstrap CSS -->
...
<body>
    <div class="d-flex">
        ...
        <div class="content flex-grow-1">
            ...
            <a href="<?php echo site_url('crud_kelas_jadwal/tambah'); ?>" class="btn btn-primary mb-3">Tambah Kelas dan Jadwal</a>
                ...
                <tbody>
                    <?php foreach ($kelas as $k): ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo site_url('crud_kelas_jadwal/edit/'.$k->id_kelas); ?>" class="btn btn-warning btn-sm">Edit</a>
                                <a href="<?php echo site_url('crud_kelas_jadwal/hapus/'.$k->id_kelas); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus?');">Hapus</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
