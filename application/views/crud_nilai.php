...
<body>
    <div class="container">
        ...
        <div class="content">
            <h1>Kelola Nilai</h1>
            <h1><a href="<?php echo site_url('tambah_nilai'); ?>">Tambah Nilai</a></h1>
            <table>
                <thead>
                    <tr>
                        <th>ID Nilai</th>
        ...
        <td>
                                    <a href="<?php echo site_url('CRUD_nilai/edit/' . $n->id_nilai); ?>">Edit</a> |
                                    <a href="<?php echo site_url('CRUD_nilai/delete/' . $n->id_nilai); ?>" onclick="return confirm('Yakin ingin menghapus?')">Hapus</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    <?php else : ?>
                        <tr>
                            <td colspan="6" style="text-align: center;">Data nilai belum tersedia.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
